function addNewRowToTable(tableBody, country, totalCases, totalDeaths, todayCases, todayDeaths) {
    let newRow = tableBody.insertRow(-1);
    newRow.innerHTML = '<td>' + country + '</td>' + '<td>' + totalCases + '</td>' + '<td>' + totalDeaths + '</td>' + '<td>' + todayCases + '</td>' + '<td>' + todayDeaths + '</td>';
}
